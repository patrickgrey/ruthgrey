...
$('#unicornMoving').click(
		...
		function (event) {
			TweenMax.to(unicorn, time, {x:'+='+how_far+'px', onStart: play_sound, onComplete: I_am_complete});
		}
...
var I_am_complete = function () {
  ...
  console.log('I am the blue rectangle and I am this fat: ', width_of_blue_rectangle.right);
